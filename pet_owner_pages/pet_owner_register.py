...
def register():
    ...
    st.header("Pet Owner Registration")
    st.write("Enter your email to register. If your email is already in our system, you'll need to switch to login.")

    email = st.text_input("Email", placeholder="you@gmail.com", key="register_email")
