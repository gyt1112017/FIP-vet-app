...
def show():
    ...
    st.video("https://www.youtube.com/watch?v=vC4dLeqnvAw")  # Replace with your video
    ...
    with col2:
        ...
        <div style="border:2px solid #9b26b6; border-radius:15px; padding:1rem; margin-bottom:1rem;">
            ...
            <p>The veterinary prescribing cascade Small Animal and Equine by By  Dr. Mark Bowen BVetMed MMedSci(MedEd) Ph.D. Cert VA Cert EM(IntMed) Dip ECVSMR Dip ACVIMLAIM PFHEA FRCVS.</p>
